				...
				<div class="d-flex flex-row-reverse justify-content-between">
					<div class="col-10 d-flex justify-content-between card p-3">
								...
								<div class="row m-0 p-0 justify-content-center">
									<div class="w-75">
										<div class="d-flex flex-wrap col-12 mb-3">
											<label for="employeeFirstName" class="col-12 col-md-3 my-auto">
												First Name
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-6">
												<input type="text" name="employeeFirstName" id="employeeFirstName" class="form-control col-12" placeholder="First Name" />
												<label for="employeeFirstName" class="text-danger error"></label>
											</div>
										</div>
										<div class="d-flex flex-wrap col-12 mb-3">
											<label for="lastName" class="col-12 col-md-3 my-auto">
												Last Name
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-6">
												<input type="text" name="employeeLastName" id="employeeLastName" class="form-control col-12" placeholder="Last Name" />
												<label for="employeeLastName" class="text-danger error"></label>
											</div>
										</div>
										<div class="d-flex flex-wrap col-12 mb-3">
											<label for="employeeEmail" class="col-12 col-md-3 my-auto">
												Email-Id
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-6">
												<input type="text" name="employeeEmail" id="employeeEmail" class="form-control col-12" placeholder="Email-Id" />
												<label for="employeeEmail" class="text-danger error"></label>
											</div>
										</div>
										<div class="d-flex flex-wrap  col-12 mb-3">
											<label for="employeeMobile" class="col-12 col-md-3 my-auto">
												Mobile No
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-6">
												<input type="number" name="employeeMobile" id="employeeMobile" class="form-control col-12 no-e" placeholder="Mobile No" />
												<label for="employeeMobile" class="text-danger error"></label>
											</div>
										</div>
										<div class="d-flex flex-wrap col-12 mb-3">
											<label for="employeDOB" class="col-12 col-md-3  my-auto">
												Date Of Birth
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-6 d-flex flex-wrap position-relative">
												<input type="text" name="employeeDOB" id="employeeDOB" class="form-control col-12" placeholder="dd/mm/yyyy" readonly="readonly" />
												<label for="employeeDOB" class="text-danger error"></label>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="tab">
							...
							<button type="button" class="btn btn-primary m-4 addEmploymentButton" data-bs-toggle="modal" data-bs-target="#AddEmploymentModel">
								<span class="mx-2 fs-5 fw-bold">+</span>
									...
									<div class="container col-12 col-md-5">
										<div class="card-body rounded-3 border expertCard text-wrap">
											<div class="d-flex justify-content-center">
												<input type="radio" value="entrylevel" id="entrylevel" name="expertiseLevel" class="m-2 expertiseLevel" />
												<label for="entrylevel" class="card-title m-0 text-center p-0 border-0">Entry Level</label>
											</div>
									...
									<div class="container col-12 col-md-5">
										<div class="card-body rounded-3 border expertCard text-wrap">
											<div class="d-flex justify-content-center">
												...
												<label for="intermediateLevel" class="card-title m-0 text-center p-0 border-0">Intermediate</label>
											</div>
									...
									<div class="container col-12 col-md-5">
										<div class="card-body rounded-3 border expertCard text-wrap">
											<div class="d-flex justify-content-center">
												...
												<label for="expertLevel" class="card-title m-0 text-center p-0 border-0">Expert</label>
											</div>
										...
										<div class="row m-0 p-0">
											...
											<div class="d-flex col-12 col-md-5 my-2">
												...
												<div class="col-8 d-flex flex-wrap align-items-center">
													...
													<label id="languagesProficiency-error" class="error text-danger" for="languagesProficiency"></label>
												</div>
											</div>
							...
							<div class="form-tab-content p-3 ">
								...
								<div class="d-flex ">
									<div class="col-9 d-flex flex-column">
										<label for="employeeHourRate">
											Hourly Rate
											<sup>*</sup>
										</label>
										<strong class="text-secodary">Total amount client will see</strong>
									</div>
									<div class="col-3 d-flex">
										<input type="number" name="employeeHourRate" id="employeeHourRate" class="form-control" placeholder="0.0" />
								...
								<div class="d-flex ">
									<div class="col-9 d-flex flex-column">
										...
										<strong class="text-secodary">The service fee is % when you begin a contract with new client</strong>
									</div>
									<div class="col-3 d-flex">
										<input type="number" name="serviceFee" id="serviceFee" class="form-control no-e" placeholder="0.0" />
										<label for="serviceFee" class="text-secondary my-auto fw-bold ms-3">/hr</label>
									</div>
								</div>
								...
								<div class="d-flex mb-4">
									<div class="col-9 d-flex flex-column">
										<label for="finalAmount">You will Recieve</label>
										<strong class="text-secodary">The estimated amount after you will recieve after service fees</strong>
									</div>
									<div class="col-3 d-flex">
										<input type="number" readonly="readonly" name="finalAmount" id="finalAmount" class="no-e form-control" placeholder="0.0" />
										<label for="finalAmount" class="text-secondary my-auto fw-bold ms-3">/hr</label>
									</div>
								</div>
							</div>
						</div>
						<div class="tab">
							<div class="tab-form-content p-3">
								...
								<div class="d-flex justify-content-center">
									<div class="w-75">
										<div class="row mb-3">
											<label for="resumeTitle" class="col-sm-3 col-form-label">
												Resume Title
												<sup>*</sup>
											</label>
											<div class="col-sm-6">
												<input type="text" class="form-control" id="resumeTitle" name="resumeTitle" placeholder="Resume Title">
												<label for="resumeTitle" class="error text-danger"></label>
											</div>
										</div>
										<div class="row mb-3">
											<label for="employeeskill" class="col-sm-3 col-form-label">
												Skills
												<sup>*</sup>
											</label>
											<div class="col-sm-6">
										...
										<div class="row mb-3">
											<label for="employeeResume" class="col-sm-3 col-form-label">
												Upload Resume
												<sup>*</sup>
											</label>
											<div class="col-sm-6">
												<input class="form-control" type="file" id="employeeResume" name="employeeResume">
												<label for="employeeResume" class="error text-danger"></label>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-2 d-flex flex-column custome-h justify-content-around">
						<div class="d-flex text-secondary">
							<label for="" class="col-9 wiz-label">
								<strong>Personal Details</strong>
							</label>
							<span class="step mx-2 text-white">
								<em class="wizard-icon ri-check-fill"></em>
							</span>
						</div>
						<div class="d-flex text-secondary">
							<label for="" class="col-9 wiz-label">
								<strong>Employement Details</strong>
							</label>
							<span class="step mx-2 text-white">
								<em class="wizard-icon ri-check-fill"></em>
							</span>
								...
								<div class="form-tab-content p-3 w-100">
									...
									<div class="row mb-3">
										<div class="d-flex col-12 col-md-6 mb-3">
											...
											<div class="col-8 d-flex flex-wrap align-items-center">
												<input type="text" name="companyName" id="companyName" placeholder="Please enter company name" class="form-control col-12" />
												<label id="companyName-error" class="error text-danger" for="companyName"></label>
											</div>
										</div>
										<div class="d-flex col-12 col-md-6 mb-3">
											...
											<div class="col-8 d-flex flex-wrap align-items-center">
												...
												<label id="currentLocation-error" class="error text-danger" for="currentLocation"> </label>
											</div>
									...
									<div class="row mb-3">
										<div class="d-flex col-12 col-md-6 mb-3">
											...
											<div class="col-8 d-flex flex-wrap align-items-center">
												<input type="number" name="pincode" id="pincode" placeholder="Please enter pincode" class="form-control col-12" />
												<label id="pincode-error" class="error text-danger" for="pincode"></label>
											</div>
										</div>
										<div class="d-flex col-12 col-md-6 mb-3">
											...
											<div class="col-8 d-flex flex-wrap align-items-center">
												...
												<label id="prefferedLocation-error" class="error text-danger" for="prefferedLocation"></label>
											</div>
										</div>
									</div>
									<div class="row mb-3">
										<div class="d-flex col-12 col-md-6 mb-3">
											...
											<div class="col-8 d-flex flex-wrap align-items-center">
												...
												<label class="text-danger error" for="industryType"></label>
											</div>
										</div>
										<div class="d-flex col-12 col-md-6 mb-3">
											<label for="totalWorkExperiance" class="col-4 my-auto" style="letter-spacing: 0.25px">
												Total Work Experiance
												<sup class="text-danger">*</sup>
											</label>
											<div class="col-8 d-flex flex-wrap align-items-center">
												<input type="number" name="totalWorkExperiance" id="totalWorkExperiance" placeholder="Please enter work experiance"
													class="form-control col-12" />
												<label id="totalWorkExperiance-error" class="error text-danger" for="totalWorkExperiance"></label>
											</div>
										</div>
									</div>
									<div class="row mb-3">
										<div class="d-flex col-12 col-md-6 mb-3">
											...
											<div class="col-8 d-flex flex-wrap align-items-center">
												...
												<label id="currentDesignation-error" class="error text-danger" for="currentDesignation"></label>
											</div>
										</div>
										<div class="d-flex col-12 col-md-6 mb-3">
											<label for="other" class="col-4 my-auto">Other</label>
											<div class="col-8 d-flex flex-wrap align-items-center">
												<input type="text" name="other" id="other" placeholder="Please enter other details if any" class="form-control col-12" />
									...
									<div class="row mb-3">
										<div class="d-flex col-12 col-md-6 mb-3">
											...
											<div class="col-8 d-flex flex-wrap align-items-center">
												<input type="text" name="description" placeholder="Please enter description" id="description" class="form-control col-12" />
										...
										<div class="d-flex col-12 col-md-6 mb-3">
											...
											<div class="col-8 d-flex flex-wrap align-items-center">
												<input type="file" name="profilePhoto" id="profilePhoto" class="form-control col-12" />
												<label id="profilePhoto-error" class="error text-danger" for="profilePhoto"></label>
											</div>
										</div>
									</div>
									<div class="row mb-3">
										<div class="d-flex col-6 mb-3 d-flex flex-wrap align-items-center">
											<input type="radio" name="currentlyWorking" id="currentlyWorking" />
											<label for="currentlyWorking" class="my-auto ms-2">Currently Working in this Company</label>
										</div>
									</div>
								</div>
							</div>
								...
								<form action="" id="educationDetail">
									<div class="row  mb-3">
										<div class="col-12 col-md-6 d-flex flex-wrap">
											<label for="schoolName" class="col-12 col-md-4">
												School Name
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-8">
												<input type="text" name="schoolName" id="schoolName" class="form-control" placeholder="School Name" />
												<label for="schoolName" class="text-danger error customehide"></label>
											</div>
										</div>
										<div class="col-12 col-md-6 d-flex flex-wrap">
											<label for="streamName" class="col-12 col-md-4">
												Stream
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-8">
												<div class="">
													...
													<label for="streamName" class=" error text-danger customehide"></label>
												</div>
											</div>
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-12 col-md-6 d-flex flex-wrap">
											<label for="degree" class="col-12 col-md-4">
												Degree
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-8">
									...
									<div class="row mb-3">
										<div class="d-flex flex-wrap col-12 col-md-6 mb-3 ">
											<label for="educationStartDate" class="col-12 col-md-4 my-auto">
												Start Date
												<sup>*</sup>
											</label>
										...
										<div class="col-12 col-md-6 mb-3 d-flex flex-wrap">
											<label for="educationEndDate" class="col-12 col-md-4 my-auto">
												End Date
												<sup>*</sup>
											</label>
											<div class="col-12 col-md-8 d-flex flex-wrap  position-relative">
												<input type="text" name="educationEndDate" id="educationEndDate" readonly="readonly" class="form-control" placeholder="End Date" />
												<label id="educationEndDate-error" class="error text-danger customehide " for="educationEndDate"></label>
											</div>
										</div>
									</div>
									<div class="row mb-3">
